...
// Data denah untuk semua projects
const denahData = {
  p1: [
    {
      label: 'Lantai 1',
  ...
  <text x="20" y="375" fill="#6b7280" font-size="7">SKALA 1:150  |  LT.1 ≈ 200 m²</text>
    ...
    {
      label: 'Lantai 2',
      svg: `<svg viewBox="0 0 520 380" xmlns="http://www.w3.org/2000/svg"><rect width="520" height="380" fill="#0d0d1a"/><text x="260" y="18" text-anchor="middle" fill="#c9a96e" font-size="10" font-weight="600">LANTAI 2</text><text x="260" y="375" fill="#6b7280" font-size="7">LANTAI 2 — MANSION CLASSIC MODERN</text></svg>`
    },
    {
      label: 'Lantai 3',
      svg: `<svg viewBox="0 0 520 380" xmlns="http://www.w3.org/2000/svg"><rect width="520" height="380" fill="#0d0d1a"/><text x="260" y="18" text-anchor="middle" fill="#c9a96e" font-size="10" font-weight="600">LANTAI 3</text><text x="260" y="375" fill="#6b7280" font-size="7">LANTAI 3 — MANSION CLASSIC MODERN</text></svg>`
    }
  ],
  // Add p2-p8 dengan struktur yang sama (simplified untuk demo)
  p2: [{ label: 'Lantai 1', svg: `<svg viewBox="0 0 520 380" xmlns="http://www.w3.org/2000/svg"><rect width="520" height="380" fill="#050a18"/><text x="260" y="18" fill="#60a5fa" font-size="10">NEO-FUTURISTIK LT.1</text></svg>` }],
  p3: [{ label: 'Lantai 1', svg: `<svg viewBox="0 0 520 380" xmlns="http://www.w3.org/2000/svg"><rect width="520" height="380" fill="#0e0a05"/><text x="260" y="18" fill="#d97706" font-size="10">MODERN TROPIS LT.1</text></svg>` }],
  p4: [{ label: 'Lantai 1', svg: `<svg viewBox="0 0 520 380" xmlns="http://www.w3.org/2000/svg"><rect width="520" height="380" fill="#050e05"/><text x="260" y="18" fill="#22c55e" font-size="10">GARASI DOUBLE LT.1</text></svg>` }],
  p5: [{ label: 'Denah', svg: `<svg viewBox="0 0 520 380" xmlns="http://www.w3.org/2000/svg"><rect width="520" height="380" fill="#0a0a0a"/><text x="260" y="18" fill="#9ca3af" font-size="10">WEIRD COFFEE</text></svg>` }],
  p6: [{ label: 'Lantai 1', svg: `<svg viewBox="0 0 520 380" xmlns="http://www.w3.org/2000/svg"><rect width="520" height="380" fill="#080510"/><text x="260" y="18" fill="#a78bfa" font-size="10">SILINDER ORGANIK LT.1</text></svg>` }],
  p7: [{ label: 'Lantai 1', svg: `<svg viewBox="0 0 520 380" xmlns="http://www.w3.org/2000/svg"><rect width="520" height="380" fill="#080808"/><text x="260" y="18" fill="#e5e7eb" font-size="10">DARK CONCRETE LT.1</text></svg>` }],
  p8: [{ label: 'Lantai 1', svg: `<svg viewBox="0 0 520 380" xmlns="http://www.w3.org/2000/svg"><rect width="520" height="380" fill="#0e0a04"/><text x="260" y="18" fill="#d97706" font-size="10">MINIMALIS TROPIS LT.1</text></svg>` }]
};
